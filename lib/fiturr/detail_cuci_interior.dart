// fiturr/detail_cuci_interior_page.dart (FIXED)
...
class DetailCuciInteriorPage extends StatefulWidget {
  const DetailCuciInteriorPage({super.key});

  @override
  State<DetailCuciInteriorPage> createState() => _DetailCuciInteriorPageState();
}

class _DetailCuciInteriorPageState extends State<DetailCuciInteriorPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: FutureBuilder<ServiceModel?>(
        future: _serviceFirebase.getService('cuci_interior'),
                    ...
                    children: [
                      ...
                      Text(
                        service.description.isNotEmpty
                            ? service.description
                            : "Membersihkan seluruh bagian dalam mobil (interior) menggunakan vacuum cleaner dan cairan pembersih khusus interior.",
                        style: const TextStyle(
                          fontSize: 13,
                          color: Colors.black87,
                          height: 1.5,
